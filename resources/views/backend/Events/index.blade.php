...
@section('add-menu')
<a  class="float-right" href="{{ route('app.events.create') }}">
  <label class="badge badge-success">Create event</label>
</a>
@endsection
        ...
        <table id="order-listing" class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{route('app.events.edit',$event->id)}}">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form id="deleteform{{ $event->id }}"
                        action="{{ route('app.events.destroy',$event->id) }}" method="POST"
                        style="display: none;">
                        @csrf()
                        @method('DELETE')
                      </form>
